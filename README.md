...
Terraform（0.12.x→0.13.x）やNode.js(14.x→20.x)のバージョンアップE、C2で動かしていたJenkinsの2.xへのアップグレード、その他配信サーバの改善や新しいアドタグの開発をしました。
...
- 1からの簡単な環境構築
  - モダンWebならNext/Nuxtかviteでいいと思っている
...
- フレックスタイム制導入
- リモート勤務導入
  - 東京在住ですがフルリモートの場合はオフィス所在地を問いません。
  - 都内であれば週2日が限度です
- SES/受託開発はすみませんが現在検討しておりません。

#### その他WANT条件

- フルフレックスタイム制導入or裁量労働制
- フルリモート勤務導入
- 各種手当て
  - 例）病床休暇、住宅補助、企業型DC
